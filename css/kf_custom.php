...
body {
    font: <?php echo $options['body_font']['value']['weight']; ?> <?php echo $options['body_font']['value']['size']; ?>px/<?php echo $options['body_font']['value']['line-height']; ?>px "<?php echo str_replace('+', ' ', $options['body_font']['value']['font-family']); ?>" Arial, Helvetica, sans-serif;;
...
color: <?php echo $options['nav_current_link']['value']['default']; ?>;
    ...
    .main-navigation .current-menu-item > ul a, .main-navigation .current-menu-ancestor > ul a, .main-navigation .current_page_item > ul a, .main-navigation .current_page_ancestor > ul a {
    }
