...
<?php
		...
		?>
                ...
                <div id="add_remove_wrap"><span id="add_box" class="button-secondary" title="Add Box">+</span><?php if (count($instance['home_box_content']) > 1) {echo '<span id="remove_box" class="button-secondary" title="Remove Box">-</span>';
		}
		?></div>
              </div>
