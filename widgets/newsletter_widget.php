 ...
 * Description: Signup for the KwikTheme Launcht newsletter
 * Version: 0.1
 *
 */
...
/*					if (email=="Enter Email" || email=="" || first=="Enter First Name" || first=="" || last=="Enter Last Name" || last=="" ){
		...
		$form .= '<input type="text" class="text_field" name="email" placeholder="'.__('Email','kwik').'" id="email" />';
		//$form .= '<input type="text" class="text_field" name="first_name" placeholder="'.__('First Name','kwik').'" id="first_name" />';
		//$form .= '<input type="text" class="text_field" name="last_name" placeholder="'.__('Last Name','kwik').'" id="last_name" />';

		$form .= '<div class="inner submit_wrap"><span class="arrow"></span><input type="submit" name="user_submit" id="user_submit" value="'.__('Submit','kwik').'"></div>';
		$form .= '</form>';
